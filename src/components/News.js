...
export class News extends Component {
  ...
  render() {
    return <div className='conatiner my-4 mx-5 '>
      <div className='container text-center' style={{margin : '35px 0px'}}><h1>QuickNews - Top {this.props.category} Headlines</h1></div>
        ...
        {!this.state.loading && this.state.articles.map((element) => {
          return (
            <div className='col-md-4' key={element.url}>
              ...
              <NewsItem title={element.title ? element.title : ''} description={
                element.description ? element.description : ''} urlToImage={element.urlToImage ?
                  element.urlToImage : "https://static01.nyt.com/images/2022/02/23/fashion/23MUGLER-SUB/23MUGLER-SUB-facebookJumbo.jpg"}
      ...
      <div className='container d-flex justify-content-between my-5'>
        <Button title='&larr; Previous' disable={this.state.page <= 1} handler={this.handlePrevClick} />
        <Button title='Next &rarr;' disable={this.state.page + 1 > Math.ceil(this.state.totalResults / this.props.pageSize)} handler={this.handleNextClick} />
      </div>
      {/* 
       */}
